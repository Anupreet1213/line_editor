...
{
public:
    static fstream openFile(string &fileName, string &mode)
    {
        fstream file;
        if (mode == "r+")
        {
...
public:
    ...
    void saveLine(string &fileName)
    {
        ...
        {
            vector<string> words = line.toVector();
...
// {
//     cout << "handleArguments called with argc: " << argc << endl; // 😘
//     if (argc < 1 || argc > 4)
//     {
...
//     {
//         cout << "Error: Directory does not exist: " << directory << endl;
//         return;
//     }

//     if (!filesystem::exists(filePath))
//     {
//         cout << "File does not exist. Creating: " << filePath << endl;
//         ofstream(filePath).close(); // Created an empty file
//     }
